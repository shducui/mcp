...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "46b53ea4-bc9e-49cc-88e3-05813fb825f4",
  ...
  "deepseekApiKey": "sk-299ecd8a37604754a6ae584013a058c5",
  "OPENAI_API_KEY": "sk-keYjs6dkNuRblIHA79F3F0F57b644f0280Bc888fAb7b1937",
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "D:/my-ai-app/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "icon": {
...
const _Fi_CY2W5PafDmRXcC6FQ_eOPY1Z5YacsDuXqXfzW0 = (function(nitro) {
...
const plugins = [
  _Fi_CY2W5PafDmRXcC6FQ_eOPY1Z5YacsDuXqXfzW0
];
...
const _GqHhd8 = defineCachedEventHandler(async (event) => {
...
const _Wt8TWS = eventHandler(async (event) => {
...
const _bU8oc3 = eventHandler(async (event) => {
...
const _fi0skF = lazyEventHandler(() => {
...
const _lazy_UEjUI8 = () => import('../routes/api/chat.mjs');
const _lazy_px9hsv = () => import('../routes/api/transcribe-vosk.post.mjs');
const _lazy_yJOB9H = () => import('../routes/api/transcribe.post.mjs');
const _lazy_zNG29j = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/chat', handler: _lazy_UEjUI8, lazy: true, middleware: false, method: undefined },
  { route: '/api/transcribe-vosk', handler: _lazy_px9hsv, lazy: true, middleware: false, method: "post" },
  { route: '/api/transcribe', handler: _lazy_yJOB9H, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_zNG29j, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _GqHhd8, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _Wt8TWS, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _bU8oc3, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _fi0skF, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zNG29j, lazy: true, middleware: false, method: undefined }
];
...
export { useRuntimeConfig as a, readMultipartFormData as b, createError$1 as c, defineEventHandler as d, buildAssetsURL as e, getResponseStatus as f, getResponseStatusText as g, defineRenderHandler as h, publicAssetsURL as i, getQuery as j, getRouteRules as k, parseQuery as p, readBody as r, setHeader as s, toNodeListener as t, useNitroApp as u };
