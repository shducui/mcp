...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), Bn = (e) => e.startsWith("onUpdate:"), ie = Object.assign, Yr = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, rl = Object.prototype.hasOwnProperty, G = (e, t) => rl.call(e, t), k = Array.isArray, St = (e) => tr(e) === "[object Map]", Os = (e) => tr(e) === "[object Set]", L = (e) => typeof e == "function", oe = (e) => typeof e == "string", yt = (e) => typeof e == "symbol", ee = (e) => e !== null && typeof e == "object", Gr = (e) => (ee(e) || L(e)) && L(e.then) && L(e.catch), xs = Object.prototype.toString, tr = (e) => xs.call(e), qr = (e) => tr(e).slice(8, -1), nr = (e) => tr(e) === "[object Object]", zr = (e) => oe(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, en = /* @__PURE__ */ ct(
...
const Ss = (e) => !!(e && e.__v_isRef === !0), Is = (e) => oe(e) ? e : e == null ? "" : k(e) || ee(e) && (e.toString === xs || !L(e.toString)) ? Ss(e) ? Is(e.value) : JSON.stringify(e, Cs, 2) : String(e), Cs = (e, t) => Ss(t) ? Cs(e, t.value) : St(t) ? {
...
class Ls extends Fs {
  ...
  set(t, n, r, o) {
    ...
    if (!this._isShallow) {
      const a = Je(s);
      if (!Oe(r) && !Je(r) && (s = K(s), r = K(r)), !k(t) && ae(s) && !ae(r))
        return a ? !1 : (s.value = r, !0);
    }
    const i = k(t) && zr(n) ? Number(n) < t.length : G(t, n), l = Reflect.set(
      t,
      n,
      r,
      ae(t) ? t : o
...
function Xl(e, t, n = Z) {
  ...
  let u, g, m, I, R = !1, J = !1;
  if (ae(e) ? (g = () => e.value, R = Oe(e)) : Ct(e) ? (g = () => d(e), R = !0) : k(e) ? (J = !0, R = e.some((y) => Ct(y) || Oe(y)), g = () => e.map((y) => {
    if (ae(y))
      return y.value;
    if (Ct(y))
      return d(y);
  ...
  const A = (y) => {
    if (!(!(u.flags & 1) || !u.dirty && !y))
      if (t) {
        const b = u.run();
        if (o || R || (J ? b.some((V, P) => mt(V, T[P])) : mt(b, T))) {
          m && m();
          const V = Dt;
          Dt = u;
          try {
...
function zs(e) {
  k(e) ? Ut.push(...e) : pt && e.id === -1 ? pt.splice(jt + 1, 0, e) : e.flags & 1 || (Ut.push(e), e.flags |= 1), qs();
}
    ...
    if (I || R) {
      const J = () => {
        if (e.f) {
          ...
          o ? k(H) && Yr(H, s) : k(H) ? H.includes(s) || H.push(s) : I ? (d[a] = [s], m(a) && (u[a] = d[a])) : (a.value = [s], e.k && (d[e.k] = a.value));
...
function Fa(e) {
  ...
  d && Ro(d, e, "c");
  function ce(U, Y) {
    k(Y) ? Y.forEach((Me) => U(Me.bind(n))) : Y && U(Y.bind(n));
  }
  if (ce(xa, u), ce(lo, g), ce(Da, m), ce(Sa, I), ce(Na, R), ce(wa, J), ce(Aa, P), ce(Va, b), ce(Ta, V), ce(Ia, F), ce(ao, A), ce(Ca, $), k(z))
    if (z.length) {
  ...
  y && e.render === fe && (e.render = y), de != null && (e.inheritAttrs = de), re && (e.components = re), se && (e.directives = se), $ && ii(e);
}
...
function _i(e, t, n = !1) {
  ...
  if (k(s))
    ...
    for (const d in s) {
      const u = Te(d);
      if (ko(u)) {
        const g = s[d], m = i[u] = k(g) || L(g) ? { type: g } : ie({}, g), I = m.type;
        let R = !1, J = !0;
        if (k(I))
...
const uo = (e) => e === "_" || e === "__" || e === "_ctx" || e === "$stable", fo = (e) => k(e) ? e.map(Le) : [Le(e)], rc = (e, t, n) => {
  if (t._n)
    return t;
...
function ac(e, t) {
  ...
  const {
    ...
    let O, w;
    const { props: j, shapeFlag: C, transition: M, dirs: B } = c;
    if (O = c.el = i(
      c.type,
      v,
      j && j.is,
      j
    ), C & 8 ? d(O, c.children) : C & 16 && $(
      c.children,
      O,
      null,
      N,
      ...
      S,
      x
    ), B && wt(c, null, N, "created"), P(O, c, c.scopeId, S, N), j) {
      for (const ne in j)
    ...
    const q = cc(E, M);
    q && M.beforeEnter(O), r(O, p, _), ((w = j && j.onVnodeMounted) || q || B) && Ae(() => {
      w && Xe(w, N, c), q && M.enter(O), B && wt(c, null, N, "mounted");
    }, E);
  }, P = (c, p, _, N, E) => {
    if (_ && m(c, _), N)
    ...
    let B;
    if (_ && Ot(_, !1), (B = M.onVnodeBeforeUpdate) && Xe(B, _, p, c), j && wt(p, c, _, "beforeUpdate"), _ && Ot(_, !0), h.NODE_ENV !== "production" && nt && (O = 0, S = !1, w = null), (C.innerHTML && M.innerHTML == null || C.textContent && M.textContent == null) && d(x, ""), w ? (de(
      c.dynamicChildren,
      w,
      x,
      _,
      ...
      if (O & 16)
        ...
        for (let ne = 0; ne < q.length; ne++) {
          const Q = q[ne], De = C[Q], Se = M[Q];
          (Se !== De || Q === "value") && s(x, Q, De, Se, E, _);
        }
      }
      O & 1 && c.children !== p.children && d(x, p.children);
    } else !S && w == null && re(x, C, M, _, E);
    ((B = M.onVnodeUpdated) || j) && Ae(() => {
    ...
    let { patchFlag: C, dynamicChildren: M, slotScopeIds: B } = p;
    h.NODE_ENV !== "production" && // #5523 dev root fragment may inherit directives
    (nt || C & 2048) && (C = 0, O = !1, M = null), B && (x = x ? x.concat(B) : B), c == null ? (r(w, _, N), r(j, _, N), $(
      // #10007
    ...
    const x = () => {
      if (c.isMounted) {
        let { next: C, bu: M, u: B, parent: q, vnode: ne } = c;
        {
          const qe = Ei(c);
          if (qe) {
        ...
        let Q = C, De;
        h.NODE_ENV !== "production" && Pn(C || c.vnode), Ot(c, !1), C ? (C.el = ne.el, Y(c, C, S)) : C = ne, M && $t(M), (De = C.props && C.props.onVnodeBeforeUpdate) && Xe(De, q, C, ne), Ot(c, !0), h.NODE_ENV !== "production" && Mt(c, "render");
        const Se = Lo(c);
        ...
        let C;
        const { el: M, props: B } = p, { bm: q, m: ne, parent: Q, root: De, type: Se } = c, Ge = on(p);
    ...
    const w = c && c.children, j = c ? c.shapeFlag : 0, C = p.children, { patchFlag: M, shapeFlag: B } = p;
    if (M > 0) {
      if (M & 128) {
        vt(
          w,
    ...
    for (; w <= C && w <= M; ) {
      const B = c[C], q = p[M] = O ? gt(p[M]) : Le(p[M]);
      if (Xt(B, q))
        R(
          B,
          q,
    ...
    if (N !== 2 && w & 1 && x)
      if (N === 0)
        ...
        const { leave: C, delayLeave: M, afterLeave: B } = x, q = () => {
    ...
    Fo(O), Fo(w), N && $t(N), j && k(C) && C.forEach((M) => {
  ...
  if (h.NODE_ENV !== "production" && H.patchFlag > 0 && H.patchFlag & 2048 && ([T, A] = Oi(H)), F && R !== !1) {
    ...
    if (y.length) {
      if (b & 7)
        ...
        const V = Object.keys(l), P = [], $ = [];
        for (let z = 0, de = V.length; z < de; z++) {
          const re = V[z];
          vn(re) ? Bn(re) || P.push(re[2].toLowerCase() + re.slice(3)) : $.push(re);
        }
        $.length && D(
          `Extraneous non-props attributes (${$.join(", ")}) were passed to component but could not be automatically inherited because component renders fragment or text or teleport root nodes.`
        ), P.length && D(
...
function bt(e, t, n = !1, r = !1) {
  const { props: o, ref: s, patchFlag: i, children: l, transition: a } = e, f = t ? xc(o || {}, t) : o, d = {
    ...
    children: h.NODE_ENV !== "production" && i === -1 && k(l) ? l.map(Ci) : l,
    target: e.target,
...
function Ci(e) {
  const t = bt(e);
  return k(e.children) && (t.children = e.children.map(Ci)), t;
}
function Ti(e = " ", t = 0) {
...
function Le(e) {
  return e == null || typeof e == "boolean" ? rt(Pe) : k(e) ? rt(
    $e,
    null,
...
function Pc(e) {
  const t = (n) => {
    if (h.NODE_ENV !== "production" && (e.exposed && D("expose() should be called only once per setup()."), n != null)) {
      let r = typeof n;
      r === "object" && (k(n) ? r = "array" : ae(n) && (r = "ref")), r !== "object" && D(
...
function $c() {
  ...
  function f(u, g, m) {
    const I = u[m];
    if (k(I) && I.includes(g) || ee(I) && g in I || u.extends && f(u.extends, g, m) || u.mixins && u.mixins.some((R) => f(R, g, m)))
      return !0;
  }
  function d(u) {
...
async function df({
  ...
  ((a = (l = i.toolInvocations) == null ? void 0 : l.reduce((b, V) => {
    var P;
    return Math.max(b, (P = V.step) != null ? P : 0);
  }, 0)) != null ? a : 0) : 0;
  ...
  let g, m, I;
  function R(b, V) {
    const P = u.parts.find(
      ($) => $.type === "tool-invocation" && $.toolInvocation.toolCallId === b
    );
    P != null ? P.toolInvocation = V : u.parts.push({
  ...
  await ff({
    ...
    onToolCallDeltaPart(b) {
      ...
      u.toolInvocations[V.index] = $, R(b.toolCallId, $), y();
    },
    async onToolCallPart(b) {
      ...
      if (F[b.toolCallId] != null ? u.toolInvocations[F[b.toolCallId].index] = V : (u.toolInvocations == null && (u.toolInvocations = []), u.toolInvocations.push(V)), R(b.toolCallId, V), y(), n) {
        ...
        if (P != null) {
          ...
          u.toolInvocations[u.toolInvocations.length - 1] = $, R(b.toolCallId, $), y();
        }
      }
    },
    onToolResultPart(b) {
...
function Es() {
  ...
  var I = function(F, T) {
    return Lt(e, void 0, void 0, function() {
      var A, y, b, V, P, $, z, de = this;
      return Ht(this, function(re) {
        switch (re.label) {
          case 0:
            return A = m.data === void 0, y = g.value, y ? (b = s.cache.get(y), V = b && b.data, m.isValidating = !0, m.isLoading = !V, V && (m.data = V.data, m.error = V.error), P = F || o, !P || !s.isDocumentVisible() && !A || T?.forceRevalidate !== void 0 && !T?.forceRevalidate ? (m.isValidating = !1, m.isLoading = !1, [
              2
              /*return*/
            ]) : b && ($ = !!(Date.now() - b.createdAt >= s.dedupingInterval || T?.forceRevalidate), !$) ? (m.isValidating = !1, m.isLoading = !1, [
              2
              /*return*/
            ]) : (z = function() {
              return Lt(de, void 0, void 0, function() {
                ...
                return Ht(this, function(U) {
                  switch (U.label) {
                    case 0:
                      return se = Ir.get(y), se ? [3, 2] : (ye = Array.isArray(y) ? y : [y], pe = P.apply(void 0, xf([], Of(ye), !1)), Ir.set(y, pe, s.dedupingInterval), [4, ys(y, pe, s.cache, u)]);
                    case 1:
                      return U.sent(), [3, 4];
                    case 2:
...
function Tf({
  ...
  ), P = (F = Ns[A]) != null ? F : Ns[A] = He(
    "ready"
  );
  (T = b.value) != null || (b.value = Rn(n));
  const $ = (W) => (vs[y] = W, V()), z = b, de = He(void 0), re = He(void 0);
  let se = null;
  async function ye(W, { data: le, headers: me, body: Ve } = {}) {
    var xe, Ye, Rt;
    de.value = void 0, P.value = "submitted";
    ...
    try {
      ...
      if (dt.name === "AbortError")
        return se = null, P.value = "ready", null;
      a && dt instanceof Error && a(dt), de.value = dt, P.value = "error";
    } finally {
      se = null;
    }
    mf({
  ...
  const pe = async (W, le) => {
    ...
    typeof W == "function" && (W = W(z.value)), $(Rn(W));
  }, Me = (W) => {
    ...
    if (bf({
      ...
      toolCallId: W,
      toolResult: le
    }), $(me), P.value === "submitted" || P.value === "streaming")
      return;
...
const Af = {
  ...
  setup(e) {
    ...
    sn(n, async (A, y) => {
      if (console.log("--- [AI Bubble] messages 数组发生变化 ---"), !A || A.length === (y?.length || 0))
        return;
        ...
        if (console.log("最新消息对象结构:", JSON.stringify(b, null, 2)), "toolName" in b && b.toolName)
          switch (b.toolName) {
            case "navigateToPage": {
              const V = b.result;
              if (V?.page) {
                console.log(`[AI Bubble] 工具调用：检测到导航指令, 目标: ${V.page}`);
                let P = "/";
                switch (V.page) {
                  case "portfolio":
                  case "blog":
                  ...
                  case "contact":
                    ...
                    break;
                  default:
                    console.error(`[AI Bubble] 未知导航目标: ${V.page}`);
                    return;
                }
                console.log(`[AI Bubble] 正在执行页面跳转到: ${P}`), window.location.href = P;
              }
              break;
            }
            case "zoomInOnPhoto": {
              const V = b.result;
              V?.title && (console.log(`[AI Bubble] 工具调用：检测到放大图片指令, 目标: ${V.title}`), window.dispatchEvent(new CustomEvent("ai-zoom-photo", {
    ...
    function T(A) {
      A.preventDefault();
      const y = u.value, b = A.clientX, V = A.clientY, P = d.x, $ = d.y;
      let z = !1;
      function de(se) {
        const ye = se.clientX - b, pe = se.clientY - V;
        if (!z && (Math.abs(ye) > 5 || Math.abs(pe) > 5) && (z = !0, m.value = !0), z) {
          const ce = Math.min(Math.max(0, P + ye), window.innerWidth - y.offsetWidth), U = Math.min(Math.max(0, $ + pe), window.innerHeight - y.offsetHeight);
          d.x = ce, d.y = U;
        }
      }
      function re() {
